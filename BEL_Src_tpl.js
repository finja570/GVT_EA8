var app = (function() {
    ...
    var illumination = {
        ambientLight : [ .5, .5, .5 ],
        light : [
            {isOn:true, position:[0.,1.,3.], color:[1.,1.,1.]},
            {isOn:true, position:[0.,1.,-3.], color:[1.,1.,1.]},
        ]
    };
    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            case ('B'):
                ...
                break;
            case ('I'):
                deltaTransLight -= deltaRotate;
                illumination.light[0].position[0] = Math.sin(deltaTransLight) * r;
                illumination.light[0].position[2] = Math.cos(deltaTransLight) * r;

                illumination.light[1].position[0] = Math.sin(deltaTransLight) * -r;
                illumination.light[1].position[2] = Math.cos(deltaTransLight) * -r;
                break;
            case ('L'):
                deltaTransLight += deltaRotate;
                illumination.light[0].position[0] = Math.sin(deltaTransLight) * r;
